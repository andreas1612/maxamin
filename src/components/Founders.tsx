...
const founders = [
    ...
    },
    {
        ...
        bio: "Architect of the Maxamin backend: the n8n automation engine, PostgreSQL evidence store, and Synology cold vault. Ensures zero data egress, airtight chain-of-custody, and ISO-aligned retention cycles.",
        hash: "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92",
        pgp: "4096R/0xF8C2B771",
        arsenal: ["Systems Architecture", "n8n Automation", "Data Governance", "PostgreSQL", "WORM Storage"],
    },
    {
        name: "Andreas Mylonas",
        role: "Chief Technology Officer",
        code: "CTO",
        focus: "Sentinel Hardware & Radio-Layer Intel",
        bio: "Lead engineer of the Pi 5 Sentinel field probes. Expert in RF analysis across Wi-Fi, BLE, Zigbee, and Sub-GHz. Designed the hardware interlock safety system and point-of-capture SHA-256 hashing pipeline.",
        hash: "b47a16d895822be88dd33f00ecebbcf1d50eeaa409c9d4fa1cf13ad7159aa4b7",
        pgp: "4096R/0x9D22B741",
        arsenal: ["ARM64 Hardening", "RF Security", "mTLS/PKI", "Python", "Wireshark", "RTL-SDR"],
    },
];
