        ...
        <div className="pt-16">
            ...
            <section className="py-16 max-w-4xl mx-auto px-6 space-y-10">
                {[
                    ...
                    { head: "4. Data Retention", body: "Evidence artifacts are retained in The Vault (Synology WORM storage) for 60 days post-delivery. A signed Evidence Deletion Certificate is issued upon expiry. Website visitor logs are retained for 30 days." },
