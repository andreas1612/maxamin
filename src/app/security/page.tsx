    ...
    return (
        <div className="pt-16">
            ...
            <section className="py-16 max-w-4xl mx-auto px-6 space-y-8">
                {[
                    { head: "Sovereign Infrastructure", body: "All evidence processing, storage, and reporting occurs on Maxamin-owned hardware located in Cyprus. We use no cloud providers for evidence handling. The Vault is maintained on-premise under physical access control." },
                    { head: "Evidence Integrity", body: "Every artifact is cryptographically integrity-protected at the point of capture. An authenticated integrity manifest is generated per engagement run — with optional cryptographic signing for clients requiring non-repudiation." },
                    { head: "Access Control", body: "The Vault uses RBAC with 2FA for all operator access. Our proprietary orchestration engine runs 47 isolated automation workflows, each scoped to specific audit functions. No shared credentials." },
